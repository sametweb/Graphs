...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
   `100 users * 10 friends = 1000 friendship pairs`
   `Since friendships are mutual, half of this number`
...
2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
   ...
   | Degree                              | Average Friends Count        |
   | ----------------------------------- | ---------------------------- |
   | Self:                               | 5<sup>1</sup> = 5 friends    |
   | Friends:                            | 5<sup>2</sup> = 25 friends   |
   | Friends' friends:                   | 5<sup>3</sup> = 125 friends  |
   | Friends' friends' friends:          | 5<sup>4</sup> = 625 friends  |
   | Friends' friends' friends' friends: | 5<sup>5</sup> = 3125 friends |

   The degree of separation is definitely more than 4 and less than 5. That means, theoratically it would only take average of 5 connections for one person to have anyone in their extended connections.

   log<sub>(4)</sub>1000 < avg_degree_of_separation < log<sub>(5)</sub>1000
